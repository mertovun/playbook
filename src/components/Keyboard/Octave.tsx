...
export const Octave = ({ range, level, xOffset,orientation, layoutConfig }: OctaveProps) => {
  let { mapRangeToNotes } = useKeyboardPanelLayout([[ENote.C, EOctave._0], [ENote.B, EOctave._8]]); // Provide a dummy range
